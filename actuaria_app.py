...
STRUCTURE = {
    ...
    "non_vie": {
        ...
        "equipes": {
            ...
            "reglementation_nv":{"label":"Équipe Réglementation",  "icon":"🛡️","manager":"nadia", "agents":["elena","thomas","aisha","marcus"]},
        },
    },
    "vie_epre": {
