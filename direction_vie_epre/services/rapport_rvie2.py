...
def _construire_contexte_rvie2(
    ...
    lignes = [
        f"RAPPORT RSR & SFCR VIE -- {ref_client.upper()} -- Arrete {arrete}",
...
def export_html(
    ...
    try:
        ...
        contexte = _construire_contexte_rvie2(r2, r5, rr1, cli, arr)
