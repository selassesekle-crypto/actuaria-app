...
class AgentRVIE1QRTVie:
    ...
    def _generer_excel(self, result: dict) -> bytes:
        """Rapport Excel individuel R-VIE1 — 4 onglets auditables."""
        from datetime import datetime
        ...
        ajouter_onglet_hypotheses(wb, "R-VIE1", aid, dte, hyps,
        ...
        ajouter_onglet_resultats(wb, "R-VIE1", aid, dte,
        ...
        for vk in [k for k in result if "validat" in k.lower()]:
            ...
            if isinstance(val, dict) and "statut_global" in val:
                ...
                if cles:
                    ajouter_onglet_validation(wb, "R-VIE1", aid, dte, val,
                                              cles_controles=cles[:5])
                break
        ajouter_onglet_audit_trail(wb, "R-VIE1", aid, dte, result)
