...
PERIMETRE: tuple[Element, ...] = (
    ...
    Element('§14, §16, §22, §25', COUVERT,
            ...
            "⚠️ ET LA PLAGE CITÉE PAR LE CEIOPS — 24 à 48 ans selon la "
            "devise — N'EST PAS CODÉE EN SEUIL : elle vit dans le libellé de "
            "la déclaration, comme élément à instruire. La coder poserait une "
            "valeur de place dans le code, ce que ce dépôt s'interdit déjà "
            "pour les allocations en pourcentage. ⚠️ Et elle est AMBIGUË : "
            "lue comme un seuil d'ENTRÉE à 24 ans, elle se contredit — la "
            "partie extrapolée commence au LLP, soit 20 ans en euro, donc "
            "[24 ; 48] serait entièrement dans la zone que la même phrase "
            "exclut et la prime ne s'appliquerait NULLE PART. Lue comme une "
            "BORNE HAUTE, les deux moitiés tiennent. La déclaration doit dire "
            "sur quelle lecture elle se fonde. "
