...
PERIMETRE: tuple[Element, ...] = (
    ...
    Element('§78-92', BATI,
            ...
            "n'est pas construit. ⚠️⚠️ ET §82 EST LEUR PENDANT AU COMPTE DE "
            "RÉSULTAT, NON CONSTRUIT : « L'entité doit présenter les produits "
            "ou les charges afférents aux contrats de réassurance détenus "
            "SÉPARÉMENT des charges ou des produits afférents aux contrats "
            "d'assurance émis » — or `ResultatGlobal` porte huit champs et "
            "aucun ne sépare le cédé. ⚠️ LES DEUX VONT ENSEMBLE ET SE "
            "TRAITENT ENSEMBLE : bâtir §82 sans §78 c) et d) laisserait le "
            "cédé séparé au résultat et fondu au bilan, ce qui est pire que "
            "de le laisser fondu des deux côtés — un lecteur conclurait que "
            "le bilan le sépare aussi. S'y ajoute la réserve des sinistres "
    ...
    Element('§93-97', BATI,
            ...
            "⚠️⚠️ ET §93 ÉNONCE SON OBJECTIF PAR RAPPORT À TROIS ÉTATS, DONT "
            "UN QUE CETTE PLATEFORME NE PRODUIT PAS : « prises en "
            "considération avec celles fournies dans l'état de la situation "
            "financière, LE OU LES ÉTATS DE LA PERFORMANCE FINANCIÈRE ET "
            "L'ÉTAT DES FLUX DE TRÉSORERIE ». Le troisième est un état "
            "d'ENTITÉ : IFRS 17 ne l'exige pas et n'en règle rien — il ne "
            "forme donc AUCUN PAN de la norme, et il n'a pas d'élément à lui "
            "dans ce périmètre. ⚠️ Il n'est pas pour autant « hors "
            "périmètre » au sens des décisions assumées listées plus bas : "
            "cette catégorie vise ce qu'IFRS 17 prévoit et que la plateforme "
            "écarte. Celui-ci est NOMMÉ ici plutôt qu'ignoré parce que "
            "l'objectif des annexes se lit par rapport à lui. "
            "⚠️ ET AUCUN PARAGRAPHE D'IFRS 17 NE DIT CE QU'UN JEU D'ÉTATS "
            "DOIT CONTENIR : « jeu complet », « ensemble complet » et « états "
            "financiers complets » n'y figurent pas une seule fois. C'est le "
            "travail d'IAS 1. La liste des pièces d'un état daté est donc "
            "DÉRIVÉE de §78-92 et §93-132, jamais lue dans un index — et le "
            "dire évite qu'un lecteur cherche celui qui n'existe pas. "
