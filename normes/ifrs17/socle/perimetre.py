...
PERIMETRE: tuple[Element, ...] = (
    ...
    Element('§14, §16, §22, §25', COUVERT,
            ...
            "⚠️ ET LA COURBE EIOPA EMBARQUÉE N'EST PAS UNE COURBE §36 TELLE "
            "QUELLE. Le volatility adjustment est déjà écarté par le code — "
            "`core/courbe_rfr.actualiser` REFUSE une courbe `avec_va`, "
            "l'agrément de l'art. 77 quinquies devant se déclarer à chaque "
            "appel — mais l'ajustement pour risque de crédit de 10 points de "
            "base est retranché à TOUTES les maturités, et c'est une "
            "construction réglementaire, non un prix de marché observable. "
            "Il DOIT être retraité, et le retraitement SE DÉCLARE, il ne se "
            "déduit pas. ⚠️ BONNE NOUVELLE MESURÉE, ET ELLE EXPLIQUE "
            "POURQUOI SEUL LE CRA RESTE : la durée de règlement la plus "
            "longue du portefeuille est 4,76 ans (DO), très en deçà du LAST "
            "LIQUID POINT de 20 ans — l'extrapolation vers l'UFR, l'autre "
            "construction réglementaire de cette courbe, N'EST PAS ATTEINTE "
            "sur ce portefeuille."),
    Element('§17', COUVERT,
