...
|---|---|---|
| constats **ouverts** | **56** | clés réelles moins clés fermées — **tenu par `ARCH-5`** |
| dont **zones TRIÉES** (`a2` 11 · `a3` 8 · `a1` 6 · `conformite` 6 · `plan` 5 · `socle` 5 · `a4` 4 · `agents` 4 · `qualite` 3 · `a6` 2 · `charts` 1 · `services` 1) | **56** | préfixe de la clé |
