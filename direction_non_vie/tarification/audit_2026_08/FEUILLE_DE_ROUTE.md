...
| | |
|---|---|
| constats relevés (vagues 1 + 2) | **149** — *recomptés le 29/08 ; `a3/C19` et `services/C10` sont des constats NEUFS, ouverts et fermés dans leur propre lot* |
| fermés **et épinglés** | **53** |
...
- **149 constats** = en-têtes des 14 `releve_*.md`, **DEUX formes** :
