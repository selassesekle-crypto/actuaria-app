...
### ⛔ LES 64 AUTRES NE SONT PAS TRACÉS, ET JE LE DIS

`a1` 8 · `pipeline` 8 · `a3` 7 · `plan` 7 · `conformite` 6 · `a4` 5 · `a6` 5 ·
puis `a5`, `agents`, `charts`, `qualite`, `services`, `socle` à 3 chacun.
