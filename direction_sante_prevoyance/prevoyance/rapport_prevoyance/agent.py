...
def _badge_narration_prev(source: str) -> str:
...
def _export_html_prev(m1: Dict, m3: Dict, m4: Dict,
    ...
    try:
        ...
        source_badge = _badge_narration_prev(source_narration)
        if source_badge:
...
def _export_word_prev(m1: Dict, m3: Dict, m4: Dict,
    ...
    try:
        ...
        _badge = _badge_narration_prev(source_narration)
        if _badge:
            p = doc.add_paragraph()
...
class AgentRapportPrevoyance:
    ...
    def run(self,
        ...
        try:
            ...
            word_bytes  = _export_word_prev(m1, m3, m4, narration, src_narration, entite, date_arrete)
