...
def _lob_rc_auto_corporels(n1, n2, n3, n4):
    ...
    contexte = (
        ...
        "plusieurs décennies. "
        f"Avec {n_ann} années de survenance, le triangle "
        f"{'est suffisant pour l\'estimation des sinistres graves' if n_ann >= 15 else 'est insuffisant pour une branche à queue 15-25 ans — le tail factor est critique et doit être validé avec soin'}. "
